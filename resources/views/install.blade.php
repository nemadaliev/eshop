            ...
            <div class="panel-body" >
                    <form  class="form-horizontal" id="formInstall">
                        ...
                        <div id="div_database_name" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="database_name"  name="database_name" placeholder="{{ trans('install.database_name') }}" style="margin-bottom: 10px" type="text" value="eshop" />
                            </div>
                        </div>
                        ...
                        <div id="div_admin_url" class="form-group required">
                            ...
                            <div class="controls col-md-8">
                                <input class="input-md  textinput textInput form-control" id="admin_url"  name="admin_url" placeholder="{{ trans('install.admin_url') }}" style="margin-bottom: 10px" type="text" value="eshop_admin" />
                            </div>
                        </div>
